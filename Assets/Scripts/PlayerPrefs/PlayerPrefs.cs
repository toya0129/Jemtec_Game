...
/*
Playerprefsをより効率的に使用するためのスクリプト

使用方法を以下に述べる

1.	本スクリプトをプロジェクトに追加する.プロジェクト名は「PlayerPrefs」

2.	実際にPlayerprefsを用いるスクリプトの冒頭部分に
...
3.	PlayerPrefs.Flush()を使用してすべての値を保存する
	これはアプリケーション終了時や,全ての値を書き込むときに使用する
