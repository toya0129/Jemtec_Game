...
public class QuestionScript : MonoBehaviour
{
    ...
    private List<string> correct_figure = new List<string>()
    {
        ...
        "12,16,18,17",
        "15,19,16,17,18",
        "1,3,22,6,8,11,13,16,17,18",
        "1,3,5,9,15,19,21,23,6,7,8,11,13,16,17,18",
        "10,12,5,6,7",
        "7,13,17,24,12,18,19",
        "7,14,12,13",
        "6,12,11",
        "2,3,4,10,24,7,8,9,11,12,14,19",
        "1,3,6,7,8",
        "4,16,18,7,8,9,12,17",
        "2,10,14,22,7,11,12,13,17",
        "1,18,22,6,11,16,17",
        "1,3,5,15,21,6,7,8,11,16",
        "2,10,14,5,6,7,12,13",
        "2,3,4,21,24,7,8,9,12,13,14,16,17,18,19",
        "7,14,21,11,12,13,16"
    };
    ...
    {
        2,4,1,6,3,3,2,3,2,6,3,2,3,3,2,3,8,2,3,2,2,5,2,3,4,3,5,3,5,3
    };
